            ...
            foreach($cities as $city){
                if($city['city'] == $_GET["city"]){
                 echo '
                    <div class="item-div">
                        <div>
                            <h2 class="item-p">'.$city['city'].'</h2>
                            <p class="item-p">'.$city['address'].'</p>
                            <p class="item-p">'.$city['phone'].'</p>
                        </div>
                        <div>
                            <iframe src="https://www.google.com/maps/embed/v1/place?q=place_id:'.$city['id'].'&amp;key=AIzaSyB4Ctbx2DSEs-OOxvd8s9gsQ93-37G2sag&amp;language=ru" class="iframe" width="500px" height="400px" frameborder="0" style="border:0" allowfullscreen=""></iframe>
                        </div>
                    </div>
                    ';
                }
